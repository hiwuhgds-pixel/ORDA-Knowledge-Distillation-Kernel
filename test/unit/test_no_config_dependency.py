...
CORE_FILES = [
    ...
    Path("src/orda_ce_kernel/_runtime.py"),
    Path("src/orda_ce_kernel/ops/tied_teacher.py"),
    Path("src/orda_ce_kernel/ops/separate_teacher.py"),
    Path("src/orda_ce_kernel/ops/precomputed_teacher.py"),
    Path("src/orda_ce_kernel/utils/dispatcher.py"),
    Path("src/orda_ce_kernel/utils/resolver.py"),
    Path("src/orda_ce_kernel/utils/_autotune.py"),
]
