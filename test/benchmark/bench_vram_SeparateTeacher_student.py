#!/usr/bin/env python3
"""
VRAM benchmark for SeparateTeacher student CE+KL.
...
def main():
    if ORDA_WARN:
        print(ORDA_WARN)
    print_banner("BENCHMARK: VRAM backend · SeparateTeacher student")
    print_config({
        "device": str(device),
